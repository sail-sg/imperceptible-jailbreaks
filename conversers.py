...
from config import VICUNA_PATH, LLAMA_7B_PATH, LLAMA3_8B_PATH, MISTRAL_7B_PATH, TARGET_TEMP, TARGET_TOP_P   
        ...
        if no_template:
            ...
            for conv, prompt in zip(convs_list, prompts_list):
                ...
                # older models
                    ...
                    full_prompts.append(formatted_prompt)
                # newer models
                elif "mistral" in self.model_name or "llama3" in self.model_name: 
